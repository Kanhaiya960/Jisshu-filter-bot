...
#---------------------------------------------------------------
#---------------------------------------------------------------         ,
SESSION = environ.get('SESSION', 'Kanhaiya')
...
USERNAME = environ.get('USERNAME', "https://t.me/RJ_09_KANHAIYA") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002237007652'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/Blockbuster_Movies_Club')
...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002410949273')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '0'))
auth_channel = environ.get('AUTH_CHANNEL', '-1002090374492')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002152101562'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002237007652') # If anyone sends a request message to your bot, you will get it in this channel.
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://envs.sh/8L-.jpg')).split()
